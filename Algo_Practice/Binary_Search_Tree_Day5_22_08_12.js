 ...
 */
heightOriginal(node = this.root, heights = [], count = 0) {
    if (node) {
        console.log("DATA is " + node.data);
        count = count +1;
        console.log("COUNT is " +count);
        this.heightOriginal(node.left, heights, count);
        this.heightOriginal(node.right, heights, count);
        }
        if(count > heights[0] || heights.length == 0){
            heights[0] = count;
        }        
...
sizeOriginal(node = this.root, count = 0) {
    if (node) {
        count++;
...
// console.log(fullTree.heightOriginal());
console.log(fullTree.size());
console.log(fullTree.toArrInorder().length);
// fullTree.print();
// console.log(fullTree.toArrInorder().length);